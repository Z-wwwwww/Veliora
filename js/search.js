// 单个源搜索超时，取自 config.js 的聚合搜索配置
const SEARCH_TIMEOUT = (typeof AGGREGATED_SEARCH_CONFIG !== 'undefined' && AGGREGATED_SEARCH_CONFIG.timeout) || 8000;
            ...
            for (let page = 2; page <= pagesToFetch + 1; page++) {
                ...
                const pagePromise = (async () => {
                    try {
                        ...
                        const pageTimeoutId = setTimeout(() => pageController.abort(), SEARCH_TIMEOUT);
